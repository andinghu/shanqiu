 ...
 */
 ...
 console.log(obj.move(0, 2, 2));
 console.log(obj.move(2, 2, 1));
 console.log(obj.move(1, 1, 2));
 console.log(obj.move(2, 0, 1));
 console.log(obj.move(1, 0, 2));
 console.log(obj.move(2, 1, 1));
